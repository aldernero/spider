...
type SeriesOptions struct {
	...
	ShowPoints       bool       `json:"show_points" yaml:"show_points"`               // Whether to show the points
}
...
func DefaultSeriesOptions() SeriesOptions {
	return SeriesOptions{
		...
		PointStrokeColor: Color("#000000"),
		PointFillColor:   Color("#000000"),
		PointFillOpacity: 0.0,
		PointShape:       PointShapeCircle,
		ShowPoints:       true,
	}
}
